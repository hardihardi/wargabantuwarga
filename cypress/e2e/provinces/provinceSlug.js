describe(
    "Detail information about ambulans on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about bantuan kebutuhan pokok on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about Donor plasma on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about Kontak penting on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about Oksigen on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about Pemakaman on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about Rumah sakit on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about Tempat isolasi mandiri on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about Tempat vaksin on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
...
describe(
    "Detail information about Tes swab on every provinces for example DKI Jakarta",
    () => {
      beforeEach(() => { cy.visit("/provinces/dki-jakarta"); });
